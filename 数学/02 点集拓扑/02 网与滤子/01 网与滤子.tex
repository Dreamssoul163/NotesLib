...
\begin{enumerate}
    \item 对任意的$\beta,\beta'\in E$, 如果$\beta\leqslant\beta'$,
    那么$f(\beta)\leqslant f(\beta')$,
    \item 对任意的$\alpha\in D$, 存在$\beta\in E$使得$f(\beta)\geqslant\alpha$,
