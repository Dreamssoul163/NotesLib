...
\]
就称$H$是$G$的\textbf{正规子群}, 记作$H\lhd G$.
...
任给群同态$\varphi:G\to H$, 它的核$\mathrm{Ker}\,\varphi$是$G$的正规子群.

\noindent{\kaishu 证明.}

对任意的$g\in G$和$k\in\mathrm{Ker}\,\varphi$, 有
\[
    \varphi(k)=1_H\quad\implies\quad
    \varphi(gkg^{-1})=\varphi(g)\cdot1_H\cdot\varphi(g)^{-1}=1_H,
\]
即$gkg^{-1}\in\mathrm{Ker}\,\varphi$. \hfill $\qedsymbol$
