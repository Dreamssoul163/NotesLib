...
任给群$G$和非空子集$S$, 有
\[
    \langle S\rangle=\left\{\,\prod_{i=0}^nx_i\,\,\middle\vert\,
    n\in\mathbb{N},\,\,x:n\to S\cup S^{-1}\right\},
\]
...
\vspace{6pt}
首先, 对任意的$h_1,h_2\in H$, 存在自然数$n,m$和$x:n\to S\cup S^{-1},
y:m\to S\cup S^{-1}$使得
\vspace{3pt}
\[
...
\]
其次, 对任意的$h\in H$, 存在自然数$n$和$x:n\to S\cup S^{-1}$使得
\vspace{3pt}
\[
    h=\prod_{i=0}^nx_i\quad\implies\quad
    h^{-1}=\prod_{i=0}^nx_{n-i}^{-1}\in H,\\[3pt]
\]
从而$H<G$. 最后, 对任意的$s\in S$, 有$\displaystyle
s=\prod_{i=0}^0s\in H$.
...
\vspace{3pt}
第二, 证明$H\subset\langle S\rangle$. 对任意的$h\in H$,
存在自然数$n$和$x:n\to S\cup S^{-1}$使得$\displaystyle h=\prod_{i=0}^nx_i$.
接下来对$k\leqslant n$归纳证明$\displaystyle\prod_{i=0}^kx_i\in\langle S\rangle$.
首先, 当$k=0$时$\displaystyle
\prod_{i=0}^0x_i=x_0\in S\cup S^{-1}\subset\langle S\rangle$;

其次, 假设$\displaystyle\prod_{i=0}^kx_i\in\langle S\rangle$
且$k+1\leqslant n$, 那么
\[
    \prod_{i=0}^{k+1}x_i=\prod_{i=0}^kx_i\cdot x_{k+1}\in\langle S\rangle,
\]
归纳成立. 取$k=n$即得$\displaystyle h=\prod_{i=0}^nx_i\in\langle S\rangle$,
即$H\subset\langle S\rangle$. \hfill $\qedsymbol$
...
任给群$G$和非空子集$S$, 如果$\forall x,y\in S:\,xy=yx$, 那么
$\langle S\rangle$是交换群.

\noindent{\kaishu 证明.}

如果$S$是交换子集, 易证$S\cup S^{-1}$也是交换子集.

对任意的$h_1,h_2\in\langle S\rangle$, 存在自然数$n,m$和$x:n\to S\cup S^{-1},
y:m\to S\cup S^{-1}$使得
\vspace{3pt}
\[
